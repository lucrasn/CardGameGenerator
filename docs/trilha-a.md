...
`padroes-de-projeto.md`, com as assinaturas conferidas contra o código atual. A
especificação da Trinca permanece nesta branch e a do Blackjack é mantida em
`jogo/blackjack`.
